...
export default function Reply({reply}) {
    ...
    const [updateCommentText, setupdateCommentText] = useState(reply.content)
    ...
    return (
        <div className='ml-2 md:ml-3 lg:ml-10'>
            <div className=' p-4 mb-4  bg-white rounded-md lg:flex lg:flex-row-reverse'>
                <div className='w-full'>
                     {/* header */}
                    <div className='flex items-center'>
                        <img className='w-8 h-8' src={reply.user.image.png} />
                        <p className='font-bold mx-4'>{reply.user.username}</p>
                        <span className='text-grayish_blue text-sm'>{reply.createdAt}</span>
                    ...
                    <div className='my-3 text-dark_blue '>
                        ...
                        :
                            <>
                                <span className='text-moderate_blue mr-1 font-bold'>@{reply.replyingTo}</span>
                                {updateCommentText}
                            </>
            ...
            <div>
                {
                    IsReplyClicked ? (<ReplyBox comment={reply} setIsReplyClicked={setIsReplyClicked} />) : (null)
                }
            </div>
        </div>
